...
public class ProductInfoPage {
	...
	public int getProductImagesCount() {
		int imagesCount=eleUtil.waitForAllElementsVisible(productImages, AppConstants.MEDIUM_DEFAULT_TIMEOUT).size();
	...
	public Map<String,String> getProductDetailsMap() {
		...
		productMap.put("productimages", String.valueOf(getProductImagesCount()));//wrapper class
		getProductMetaData();
		getProductPriceData();
		System.out.println("product details are:"+ productMap);
		return productMap;
