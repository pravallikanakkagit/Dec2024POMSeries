...
public class RegisterPage {
	...
	public RegisterPage(WebDriver driver) {
		...
		public boolean userRegisteration(String firstName, String lastName, 
			...
			eleUtil.waitForElementVisible(this.firstName, AppConstants.MEDIUM_DEFAULT_TIMEOUT).sendKeys(firstName);
			...
			if(eleUtil.doElementGetText(successMessg).contains(AppConstants.REGISTER_SUCCESS_MESSG)) {
